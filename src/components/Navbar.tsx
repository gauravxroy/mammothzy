        ...
        <>
            <div className="bg-white mb-8">
                ...
                <div className="relative isolate px-6 pt-14 lg:px-8">
                    ...
                    <div className="mx-auto max-w-2xl py-20 sm:py-20 lg:py-12">
                        ...
                        <div className="text-center">
                            <h1 className="text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
                                Elevate Team Bonding with Unique Experiences
                            </h1>
                            <p className="mt-7 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
                                Explore and book thrilling activities like Go-Karting, Paintball, Camping, and more to foster stronger connections and boost team morale.
                            </p>
